...
import ImageWithSpace from '../src/components/imageWithSpace/ImageWithSpace'
...
function LoginPage() {
  ...
  return (
    <ImageWithSpace>
      <H1>#Pra vida toda</H1>
      <H4>A máquina do tempo</H4>
      <FormContainer>
        <H2>Entre na sua conta!</H2>
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Input label="E-mail ou usuário" name="userOrEmail" control={control} />
          <Input label="Senha" type="password" name="password" control={control} />
          <Button loading={loadingButton} type="submit" disabled={Object.keys(errors).length}>
            Entrar
          </Button>
        </Form>
        <Text>
